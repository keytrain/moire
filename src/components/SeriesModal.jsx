...
import sData from "../data/seriesData.json";
...
class SeriesModal extends Component {
  constructor(props) {
    ...
    this.selInfo = sData[this.selection];
    this.selChaps = chData[this.selection]
      ? Object.keys(chData[this.selection])
          .sort((a, b) => {
        ...
        <div className="modal">
          ...
          <div className="modal-right">
            <div className="modal-text">
              <h3 className="modal-header">{this.selection}</h3>
              <h5 className="modal-subheader">{this.selInfo.author}</h5>
                        ...
                        <Link key={index} to={`/r/${this.selection}/${e}/0`}>
                          <div className="modal-chapter">
                            ...
                            <div className="modal-chapter-date">
                              {genLib.howLongAgo(chData[this.selection][e].date)} ago
                            </div>
                          </div>
                        </Link>
                      );
